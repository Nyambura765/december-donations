...
const metadata = {
  name: 'december-donations', // PayU - project name or app name
  description: 'A Dapp for december donations', // PayU what something something 
